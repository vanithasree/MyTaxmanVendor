...
extension UIButton {
    ...
    func addBottomBorderWithColor(color:CGColor) {
    ...
    func setDarkGreenTheme(btn:UIButton, title:String) {
        ...
        btn.backgroundColor = ColorManager.textThickDarkGreenColor.color
    ...
    func setThickGreenColor(btn:UIButton, title:String) {
        
        btn.backgroundColor = .white
        btn.setTitle(title, for: .normal)
    btn.setTitleColor(ColorManager.textThickDarkGreenColor.color, for: .normal)
        btn.titleLabel?.font =  UIFont(name:Font.FontName.PoppinsMedium.rawValue, size: Utility.dynamicSize(16.0))
        btn.titleLabel?.adjustsFontForContentSizeCategory = false
        
    }
    
    func setGreenColor(btn:UIButton, title:String) {
        
        btn.backgroundColor = .white
        btn.setTitle(title, for: .normal)
        btn.setTitleColor(ColorManager.textLiteGreenColor.color, for: .normal)
        btn.titleLabel?.font =  UIFont(name:Font.FontName.PoppinsMedium.rawValue, size: Utility.dynamicSize(16.0))
        btn.titleLabel?.adjustsFontForContentSizeCategory = false
