...
struct VenProfileBase : Codable {
    let code : String?
    let desc : [VenProfileDesc]?
    let featured : String?
    let profile_pic : String?
    let reviews : [VenProfileReviews]?
    let averageRating : [VenProfileAverageRating]?
    let jobWon : [VenProfileJobWon]?
    let reviewCount : [VenProfileReviewCount]?
    ...
    init(from decoder: Decoder) throws {
        ...
        desc = try values.decodeIfPresent([VenProfileDesc].self, forKey: .desc)
        featured = try values.decodeIfPresent(String.self, forKey: .featured)
        profile_pic = try values.decodeIfPresent(String.self, forKey: .profile_pic)
        reviews = try values.decodeIfPresent([VenProfileReviews].self, forKey: .reviews)
        averageRating = try values.decodeIfPresent([VenProfileAverageRating].self, forKey: .averageRating)
        jobWon = try values.decodeIfPresent([VenProfileJobWon].self, forKey: .jobWon)
        reviewCount = try values.decodeIfPresent([VenProfileReviewCount].self, forKey: .reviewCount)
...
struct VenProfileAverageRating : Codable {
...
struct VenProfileJobWon : Codable {
...
struct VenProfileReviewCount : Codable {
...
struct VenProfileReviews : Codable {
    let review : String?
